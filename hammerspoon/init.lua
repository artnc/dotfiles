...
local registeredApps = {
  ...
  {space=3, app="Sublime Text", layout=hs.layout.left50},
  {space=3, app="Alacritty", layout=hs.layout.right50},
  {space=4, app="Slack"},
  {space=5, app="Xcode", layout=hs.layout.left50},
  {space=5, app="Simulator", layout=hs.layout.right50},
